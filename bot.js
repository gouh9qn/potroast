            ...
            collector.on('collect', m => {
              if(m.content.startsWith('pr!confirm'))
              {
                ...
                msg.channel.send(embeded).then((res) =>
                {
                  ...
                  payouts.set('1112', {val: 50, text: 'Dough'});
                  payouts.set('1113', {val: 50, text: 'Expensive Dog'});
                  payouts.set('1114', {val: 50, text: 'Expensive Poop'}),
                  payouts.set('1122', {val: 25, text: 'Expensive Pizza'});
                  payouts.set('1123', {val: 12, text: 'Expensive Dogs and Pizzas'});
                  payouts.set('1222', {val: 12, text: 'Lots of Dollar Store Pizza'});
                  payouts.set('1223', {val: 10, text: 'Lots of Dollar Store Pizza and Dogs'});
                  ...
                  payouts.set('2233', {val: 4, text: 'Lots of Pizza and Dogs'});
                  payouts.set('2333', {val: 2, text: 'Lots of Dogs'});
                  payouts.set('3333', {val: 10, text: 'Lots of Dogs'});
